...
namespace com.esri.core.geometry
{
	...
	public class TestConvexHull
	{
		...
		{
			com.esri.core.geometry.OperatorConvexHull bounding = (com.esri.core.geometry.OperatorConvexHull
				...
				.DensifyByLength);
			{
				...
				com.esri.core.geometry.Polygon densified = (com.esri.core.geometry.Polygon)(densify
					.execute(polygon, .5, null));
				com.esri.core.geometry.Polygon convex_hull = (com.esri.core.geometry.Polygon)(bounding
					.execute(densified, null));
			...
			}
			{
				...
				mpoint.add(4, 4);
				com.esri.core.geometry.MultiPoint convex_hull = (com.esri.core.geometry.MultiPoint
					)(bounding.execute(mpoint, null));
			...
			}
			{
				...
				mpoint.add(4, 4);
				mpoint.add(4, 5);
				com.esri.core.geometry.Polyline convex_hull = (com.esri.core.geometry.Polyline)(bounding
					.execute(mpoint, null));
				NUnit.Framework.Assert.IsTrue(convex_hull.getPointCount() == 2);
				NUnit.Framework.Assert.IsTrue(bounding.isConvex(convex_hull, null));
			...
			{
				com.esri.core.geometry.Envelope env = new com.esri.core.geometry.Envelope(0, 0, 10
					, 10);
				com.esri.core.geometry.Envelope convex_hull = (com.esri.core.geometry.Envelope)(bounding
					.execute(env, null));
				NUnit.Framework.Assert.IsTrue(bounding.isConvex(convex_hull, null));
		...
		public static void testSquare()
		{
			...
			com.esri.core.geometry.OperatorContains contains = (com.esri.core.geometry.OperatorContains
				...
				.Contains);
			com.esri.core.geometry.Polygon square = new com.esri.core.geometry.Polygon();
			...
			square.lineTo(2, 1);
			com.esri.core.geometry.Polygon densified = (com.esri.core.geometry.Polygon)(densify
				.execute(square, 1.0, null));
			com.esri.core.geometry.Polygon convex_hull = (com.esri.core.geometry.Polygon)(bounding
				.execute(densified, null));
			com.esri.core.geometry.Polygon differenced = (com.esri.core.geometry.Polygon)(difference
				.execute(densified, convex_hull, com.esri.core.geometry.SpatialReference.create(
				4326), null));
		...
		public static void testPolygons()
		{
			...
			com.esri.core.geometry.OperatorDifference difference = (com.esri.core.geometry.OperatorDifference
				...
				.Difference);
			{
				com.esri.core.geometry.Polygon shape = (com.esri.core.geometry.Polygon)(com.esri.core.geometry.TestCommonMethods
				...
				com.esri.core.geometry.Polygon convex_hull = (com.esri.core.geometry.Polygon)(bounding
					.execute(shape, null));
				com.esri.core.geometry.Polygon differenced = (com.esri.core.geometry.Polygon)(difference
					.execute(shape, convex_hull, com.esri.core.geometry.SpatialReference.create(4326
					), null));
				NUnit.Framework.Assert.IsTrue(differenced.isEmpty());
				NUnit.Framework.Assert.IsTrue(bounding.isConvex(convex_hull, null));
			}
			...
			}
			{
				...
				com.esri.core.geometry.Polygon differenced = (com.esri.core.geometry.Polygon)(difference
					.execute(polygon, convex_hull, com.esri.core.geometry.SpatialReference.create(4326
					), null));
				NUnit.Framework.Assert.IsTrue(differenced.isEmpty());
				NUnit.Framework.Assert.IsTrue(bounding.isConvex(convex_hull, null));
			}
		...
		public static void testPolylines()
		{
				...
				.Contains);
			{
				...
				com.esri.core.geometry.Polyline densified = (com.esri.core.geometry.Polyline)(densify
					.execute(poly, 10.0, null));
				com.esri.core.geometry.Polygon convex_hull = (com.esri.core.geometry.Polygon)(bounding
					.execute(densified, null));
				com.esri.core.geometry.Polyline differenced = (com.esri.core.geometry.Polyline)(difference
					.execute(densified, convex_hull, com.esri.core.geometry.SpatialReference.create(
					4326), null));
				NUnit.Framework.Assert.IsTrue(differenced.isEmpty());
				NUnit.Framework.Assert.IsTrue(bounding.isConvex(convex_hull, null));
			}
			{
				...
				com.esri.core.geometry.Polyline densified = (com.esri.core.geometry.Polyline)(densify
					.execute(polyline, 10.0, null));
				com.esri.core.geometry.Polygon convex_hull = (com.esri.core.geometry.Polygon)(bounding
					.execute(densified, null));
				bool bcontains = contains.execute(convex_hull, densified, com.esri.core.geometry.SpatialReference
					.create(4326), null);
		...
		public static void testMergeCursor()
		{
			...
			geoms[4] = geom5;
			geoms[5] = geom6;
			com.esri.core.geometry.GeometryCursor cursor = new com.esri.core.geometry.SimpleGeometryCursor
				(geoms);
			// create convex hull from the cursor with b_merge set to true
			com.esri.core.geometry.GeometryCursor convex_hull_curs = bounding.execute(cursor, 
				true, null);
			com.esri.core.geometry.Polygon convex_hull = (com.esri.core.geometry.Polygon)(convex_hull_curs
				.next());
			...
			// Test GeometryEngine
			com.esri.core.geometry.Geometry[] merged_hull = com.esri.core.geometry.GeometryEngine
				.convexHull(geoms, true);
		...
		public virtual void testHullTickTock()
		{
			...
			com.esri.core.geometry.ListeningGeometryCursor gc = new com.esri.core.geometry.ListeningGeometryCursor
				();
			com.esri.core.geometry.GeometryCursor ticktock = com.esri.core.geometry.OperatorConvexHull
				.local().execute(gc, true, null);
			...
			NUnit.Framework.Assert.IsTrue(com.esri.core.geometry.OperatorConvexHull.local().isConvex
				(convex_hull, null));
			com.esri.core.geometry.Point2D p1 = convex_hull.getXY(0);
			com.esri.core.geometry.Point2D p2 = convex_hull.getXY(1);
			com.esri.core.geometry.Point2D p3 = convex_hull.getXY(2);
