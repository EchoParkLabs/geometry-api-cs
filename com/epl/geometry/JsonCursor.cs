...
{
	/// <summary>An abstract Json String Cursor class.</summary>
	public abstract class JsonCursor
	{
		/// <summary>Moves the cursor to the next string.</summary>
		/// <remarks>Moves the cursor to the next string. Returns null when reached the end.</remarks>
