...
{
	/// <summary>An abstract JsonParser Cursor class.</summary>
	internal abstract class JsonParserCursor
	{
		/// <summary>Moves the cursor to the next JsonParser.</summary>
		/// <remarks>
		/// Moves the cursor to the next JsonParser. Returns null when reached the
		/// end.
		/// </remarks>
		public abstract org.codehaus.jackson.JsonParser Next();
