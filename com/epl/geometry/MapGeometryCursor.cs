...
namespace com.epl.geometry
{
	...
	internal abstract class MapGeometryCursor
	{
		/// <summary>Moves the cursor to the next ProjectedGeometry.</summary>
		/// <remarks>
		/// Moves the cursor to the next ProjectedGeometry. Returns null when reached
		/// the end.
		/// </remarks>
		public abstract com.epl.geometry.MapGeometry Next();
