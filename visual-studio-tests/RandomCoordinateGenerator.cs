...
namespace com.epl.geometry
{
	...
	{
		internal System.Collections.Generic.List<com.epl.geometry.Point> points;

		internal com.epl.geometry.Envelope env;
		...
		internal virtual com.epl.geometry.Point GetRandomCoord()
		{
			double f = random.NextDouble();
			com.epl.geometry.Point pt;
			if (f > 0.9)
