...
{
	public class TestWKBSupport : NUnit.Framework.TestFixtureAttribute
	{
		...
		public virtual void TestWKB()
		{
			try
			{
				...
				parser.NextToken();
				com.epl.geometry.MapGeometry mapGeom = com.epl.geometry.GeometryEngine.JsonToGeometry(parser);
